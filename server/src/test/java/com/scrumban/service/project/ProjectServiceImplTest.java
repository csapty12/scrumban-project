...
//
//            assertThrows(ProjectIdentifierException.class, () -> projectServiceImpl.saveProject(project, user.getEmail()));
//        }
//
//        @Test
...
//
//            ProjectEntity actualSavedProject = projectServiceImpl.saveProject(project, user.getEmail());
...
//            assertThrows(UsernameNotFoundException.class, () -> projectServiceImpl.saveProject(project, ""));
//        }
//
//    }
//
...
//            when(userService.getUser(anyString())).thenThrow(UsernameNotFoundException.class);
//            assertThrows(UsernameNotFoundException.class, () -> projectServiceImpl.findAllProjects(""));
//        }
//
//        @Test
...
//            when(userService.getUser(anyString())).thenReturn(user);
//            assertThrows(ProjectNotFoundException.class, () -> projectServiceImpl.findAllProjects(user.getEmail()));
//        }
//
//        @Test
...
//            Iterable<ProjectEntity> allProjects = projectServiceImpl.findAllProjects(user.getEmail());
//
...
//            projectServiceImpl.updateProject(projectEntity, user.getEmail());
...
//            ProjectEntity projectEntity = createProject();
//            when(userService.getUser(anyString())).thenThrow(UsernameNotFoundException.class);
//            assertThrows(UsernameNotFoundException.class, () -> projectServiceImpl.updateProject(projectEntity, ""));
//        }
//
//        @Test
...
//            when(userService.getUser(anyString())).thenReturn(user);
//            when(projectEntityRepository.findProjectEntityByProjectIdentifier(any())).thenReturn(Optional.empty());
//            assertThrows(ProjectIdentifierException.class, () -> projectServiceImpl.updateProject(projectEntity, user.getEmail()));
//        }
//
//        @Test
...
//            when(userService.getUser(anyString())).thenReturn(user);
//            when(projectEntityRepository.findProjectEntityByProjectIdentifier(any())).thenReturn(Optional.of(projectEntity));
//            assertThrows(ProjectNotFoundException.class, () -> projectServiceImpl.updateProject(projectEntity, user.getEmail()));
//        }
//
//    }
//
...
//            ProjectEntity project = createProject();
//            when(userService.getUser(anyString())).thenThrow(UsernameNotFoundException.class);
//            assertThrows(UsernameNotFoundException.class, () -> projectServiceImpl.deleteProject(project.getProjectIdentifier(), ""));
//        }
//
//        @Test
...
//            when(userService.getUser(anyString())).thenReturn(user);
//            when(projectEntityRepository.findProjectEntityByProjectIdentifier(any())).thenReturn(Optional.empty());
//            assertThrows(ProjectIdentifierException.class, () -> projectServiceImpl.deleteProject(projectEntity.getProjectIdentifier(), user.getEmail()));
//        }
//
//        @Test
...
//            when(userService.getUser(anyString())).thenReturn(user);
//            when(projectEntityRepository.findProjectEntityByProjectIdentifier(any())).thenReturn(Optional.of(projectEntity));
//            assertThrows(ProjectNotFoundException.class, () -> projectServiceImpl.deleteProject(projectEntity.getProjectIdentifier(), user.getEmail()));
//        }
//
//        @Test
...
//            when(userService.getUser(anyString())).thenReturn(user);
//            when(projectEntityRepository.findProjectEntityByProjectIdentifier(any())).thenReturn(Optional.of(projectEntity));
//            projectServiceImpl.deleteProject(projectEntity.getProjectIdentifier(), user.getEmail());
