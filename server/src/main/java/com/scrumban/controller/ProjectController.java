...
public class ProjectController {
    ...
    public ProjectController(ProjectServiceImpl projectService, ValidationErrorService validationErrorService, UserService userService) {
    ...
    @PostMapping
    public ResponseEntity<?> createProject(@Valid @RequestBody Project project, BindingResult bindingResult, Authentication authentication) {
        ...
        Project newProject = projectService.saveProject(project, principal.getEmail());
